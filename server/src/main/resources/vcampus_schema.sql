...
CREATE TABLE `tbl_book` (
    ...
    `category` VARCHAR(64) NOT NULL DEFAULT '未分类' COMMENT '图书分类',
...
INSERT INTO `tbl_book` (`isbn`, `title`, `author`, `publisher`, `category`, `location`, `resource_file`, `total_num`, `current_num`) VALUES
('9787111213826', 'Java编程思想', 'Bruce Eckel', '机械工业出版社', '计算机', '九龙湖馆三楼 TP312 区', NULL, 10, 10),
('9787115546081', '算法导论', 'Thomas H. Cormen', '人民邮电出版社', '计算机', '九龙湖馆三楼 TP301 区', NULL, 5, 5),
('9787302520322', '计算机网络（第7版）', '谢希仁', '电子工业出版社', '计算机', '九龙湖馆四楼 TN 区', NULL, 6, 6),
('9787115426799', '深入理解计算机系统', 'Randal E. Bryant', '机械工业出版社', '计算机', '九龙湖馆三楼 TP303 区', NULL, 4, 4);

INSERT INTO `tbl_book` (`isbn`, `title`, `author`, `publisher`, `category`, `location`, `resource_file`, `total_num`, `current_num`) VALUES
('9787115546128', '数据库系统概念', 'Abraham Silberschatz', '机械工业出版社', '计算机', '九龙湖馆三楼 TP311 区', NULL, 8, 8),
('9787115546098', '操作系统导论', 'Remzi H. Arpaci-Dusseau', '人民邮电出版社', '计算机', '九龙湖馆四楼 TP316 区', NULL, 6, 6),
('9787115546104', '编译原理', 'Alfred V. Aho', '机械工业出版社', '计算机', '九龙湖馆三楼 TP314 区', NULL, 7, 7),
('9787115546111', '人工智能：一种现代的方法', 'Stuart Russell', '人民邮电出版社', '计算机', '九龙湖馆四楼 TP18 区', NULL, 5, 5),
('9787115459602', '软件工程：实践者的研究方法', 'Roger S. Pressman', '机械工业出版社', '计算机', '九龙湖馆三楼 TP311 区', NULL, 8, 8),
('9787115351029', '高等数学（第七版）上册', '同济大学数学系', '高等教育出版社', '数学', '九龙湖馆二楼 O13 区', NULL, 12, 12),
('9787040396638', '线性代数（第六版）', '同济大学数学系', '高等教育出版社', '数学', '九龙湖馆二楼 O151 区', NULL, 10, 10),
('9787302517599', '概率论与数理统计', '盛骤', '高等教育出版社', '数学', '九龙湖馆二楼 O21 区', NULL, 10, 10),
('9787115546135', '机器学习', '周志华', '清华大学出版社', '计算机', '九龙湖馆四楼 TP181 区', NULL, 9, 9),
('9787115546142', '深度学习', 'Ian Goodfellow', '人民邮电出版社', '计算机', '九龙湖馆四楼 TP181 区', NULL, 6, 6),
('9787115459558', '鸟哥的Linux私房菜', '鸟哥', '人民邮电出版社', '计算机', '九龙湖馆四楼 TP316 区', NULL, 7, 7),
('9787115546159', 'C++ Primer（第5版）', 'Stanley B. Lippman', '电子工业出版社', '计算机', '九龙湖馆三楼 TP312 区', NULL, 8, 8),
('9787115546166', 'JavaScript高级程序设计', 'Matt Frisbie', '人民邮电出版社', '计算机', '九龙湖馆三楼 TP312 区', NULL, 6, 6),
('9787115546173', 'Python编程：从入门到实践', 'Eric Matthes', '人民邮电出版社', '计算机', '九龙湖馆三楼 TP311 区', NULL, 9, 9),
('9787115546180', '算法（第4版）', 'Robert Sedgewick', '人民邮电出版社', '计算机', '九龙湖馆三楼 TP301 区', NULL, 6, 6),
('9787115546197', '数字逻辑与计算机组成', '袁春风', '机械工业出版社', '计算机', '九龙湖馆三楼 TP303 区', NULL, 5, 5),
('9787115546203', '计算机网络：自顶向下方法', 'James F. Kurose', '机械工业出版社', '计算机', '九龙湖馆四楼 TN 区', NULL, 6, 6),
('9787115546210', '通信原理', '樊昌信', '国防工业出版社', '工程技术', '九龙湖馆四楼 TN91 区', NULL, 7, 7),
('9787115546227', '经济学原理', 'N. Gregory Mankiw', '北京大学出版社', '经济管理', '九龙湖馆五楼 F0 区', NULL, 5, 5),
('9787115546234', '管理学', '斯蒂芬·罗宾斯', '中国人民大学出版社', '经济管理', '九龙湖馆五楼 C93 区', NULL, 6, 6),
('9787115546241', '大学英语综合教程', '李荫华', '上海外语教育出版社', '外语', '九龙湖馆五楼 H31 区', NULL, 10, 10),
('9787115546258', '中国哲学简史', '冯友兰', '北京大学出版社', '人文社科', '九龙湖馆五楼 B2 区', NULL, 4, 4),
('9787115546265', '万历十五年', '黄仁宇', '生活·读书·新知三联书店', '人文社科', '九龙湖馆五楼 K248 区', NULL, 6, 6),
('9787115546272', '百年孤独', '加西亚·马尔克斯', '南海出版公司', '文学艺术', '九龙湖馆五楼 I775 区', NULL, 4, 4);
